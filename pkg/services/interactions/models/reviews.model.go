...
type ReviewDto struct {
	Type               string             `bson:"type" json:"type" validate:"required,oneof=general hotel destination program agent exhibition package"` //e.g general - hotel - destination - program - agent - exhibition - package
