...
type CustomerPersonaSvcs interface {
	...
	// V2
	GetV2(ctx context.Context, skip int64, limit int64, query *query.Conditions) (*models.CustomerPersonaPagination, error)
	GetAllV2(ctx context.Context, query *query.Conditions) ([]models.CustomerPersona, error)
}
...
func (s *customerPersonaSvcs) GetV2(ctx context.Context, skip int64, limit int64, query *query.Conditions) (*models.CustomerPersonaPagination, error) {
	...
	return &models.CustomerPersonaPagination{
		Personas: result,
...
func (s *customerPersonaSvcs) GetAllV2(ctx context.Context, query *query.Conditions) ([]models.CustomerPersona, error) {
	if err := query.CheckValid(); err != nil {
		return nil, err
	}
